<div class="container">
	...
	<div class="card">
	  <div class="card-body">
	  	<h5 class="card-title">W&uuml;nsche f&uuml;r {$product_name} <span style="font-weight: normal;"><a href="#" id="abo" class="pull-right"{if $abo} style="display: none;"{/if}><i class="fa fa-envelope-o"></i> Abonnieren</a><a href="#" id="deabo" class="pull-right"{if !$abo} style="display: none;"{/if}><i class="fa fa-envelope"></i> Deabonnieren</a></span></h5>
	  	{assign "i" "0"}
	    {foreach from=$pwishes item=info key=id}
	    {assign var="i" value=$i+1}
	    <a href="{$cfg.PAGEURL}wishlist/wish/{$id}"><h4 style="margin-top: 0; margin-bottom: 5px;">{$info->title|htmlentities}</h4></a>
	...
	<div class="card">
	  <div class="card-body">
	  <h5 class="card-title">{$wish->title|htmlentities} <span style="text-weight: normal;"><span class="label label-default pull-right"><span id="likes">{$likes}</span> gef&auml;llt das</span></span></h5>
	  
	  	<i class="fa fa-calendar"></i> {dfo d=$wish->date m=0} &nbsp; <i class="fa fa-flag"></i> <a href="{$cfg.PAGEURL}product/{$wish->product}">{$wish->product_name}</a><br /><br />
	...
	<div class="card">
	  <div class="card-body">
	  	<h5 class="card-title"><i class="fa fa-comments"></i> Kommentare <span class="label label-default pull-right">{$comments|count}</span></h5>
