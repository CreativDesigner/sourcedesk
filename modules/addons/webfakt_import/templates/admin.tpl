<div class="row">
	<div class="col-lg-12">
        ...
        <div id="doing" style="display: none;">
            ...
            <div id="clients_div" style="display: none; padding-top: 20px;">
                <p>{$addonlang.CHOOSE_CLIENTS}</p>
                <select id="clients" class="form-control" multiple="" style="height: 150px;"></select>
                <input type="button" id="continue" value="{$addonlang.CONTINUE}" class="btn btn-primary btn-block" style="margin-top: 10px;">
            </div>

            <span id="wtd"></span>

            <br /><a href="?p=webfakt_import" id="restart" class="btn btn-warning btn-block" style="display: none;">{$addonlang.RESTART}</a>
        ...
        <form class="form-horizontal" id="import_form" style="margin-top: 20px;">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="db_host" placeholder="localhost" value="{if isset($smarty.session.webfakt_import_db_host)}{$smarty.session.webfakt_import_db_host|strip_tags}{else}localhost{/if}">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="db_user" placeholder="webfakt" value="{if isset($smarty.session.webfakt_import_db_user)}{$smarty.session.webfakt_import_db_user|strip_tags}{/if}">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="password" class="form-control" id="db_password" placeholder="E57k3BYT8r" value="{if isset($smarty.session.webfakt_import_db_password)}{$smarty.session.webfakt_import_db_password|strip_tags}{/if}">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="db_name" placeholder="webfakt" value="{if isset($smarty.session.webfakt_import_db_name)}{$smarty.session.webfakt_import_db_name|strip_tags}{/if}">
                </div>
            </div>
            ...
            $("#import_form").slideUp(function() {
                ...
                $.post("", {
                    ...
                    if (!data || !data.status || data.status != "ok") {
                        ...
                        for (id in data.clients) {
                            $("#clients").append('<option value="' + id + '" selected="">' + data.clients[id] + '</option>');
                        }
