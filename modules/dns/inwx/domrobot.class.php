...
class domrobot
{
    ...
    public function call($object, $method, array $params = array(), $inwx = null, $domain = "")
    {
        ...
        if (is_object($inwx) && $inwx instanceof DomainRegistrar) {
            $domain = $domain ?: ($params['domain'] ?: "");
            $inwx->logRequest($this->address, $request, $response, $domain);
        }
