<?php
require_once __DIR__ . '/abstractLoggerHandler.php';
...
class FileLogger extends AbstractLoggerHandler {
	...
	public function __construct($path = '') {
		$this->_logfilePath = ($path != '') ? $path : __DIR__ . '/logs/log.txt';
		$this->_errorLogfilePath = __DIR__ . '/logs/error_log.txt';
		$this->_warningsLogfilePath = __DIR__ . '/logs/warning_log.txt';
	}
