<div class="container">
    ...
    <fieldset>
      ...
      <!-- Form Name -->
      <h1>{$lang.PROFILE.TITLE}<span class="pull-right"><a href="{$cfg.PAGEURL}contacts"><i class="fa fa-users"></i></a></span></h1><hr>
...
<form class="form-horizontal" id="profile-form" role="form" method="POST">
      <div class="form-group">
        <label class="col-sm-2 control-label">{$lang.PROFILE.CUSTOMER_ID}</label>
        <div class="col-sm-4">
      ...
      <div class="form-group">
        <label class="col-sm-2 control-label">{$lang.PROFILE.TELEPHONE_PIN}</label>
        <div class="col-sm-4">
      ...
      <div class="form-group">
        <label class="col-sm-2 control-label">{$lang.PROFILE.SALUTATION}</label>
        <div class="col-sm-4">
          <select name="salutation" class="form-control" style="max-width:100px;"{if "salutation"|in_array:$ro_fields} readonly="readonly" disabled=""{/if}>
      ...
      <div class="form-group">
        <label class="col-sm-2 control-label" for="textinput">{$lang.PROFILE.NAME}</label>
        <div class="col-sm-10">
          <div class="row">
            <div class="col-sm-6">
      ...
      <div class="form-group">
        <label class="col-sm-2 control-label" for="textinput">{$lang.PROFILE.NICKNAME}</label>
        <div class="col-sm-10">
  ...
  <div class="form-group">
        <label class="col-sm-2 control-label" for="textinput">{$lang.PROFILE.COMPANY}</label>
        <div class="col-sm-10">
      ...
      <!-- Text input-->
      <div class="form-group">
        <label class="col-sm-2 control-label" for="textinput">{$lang.PROFILE.MAIL}</label>
        <div class="col-sm-10">
  ...
  {if "street"|in_array:$fields || "street_number"|in_array:$fields}<div class="form-group">
        <label class="col-sm-2 control-label" for="textinput"{if !("street"|in_array:$duty_fields) && !("street_number"|in_array:$duty_fields)} style="font-weight: normal;"{/if}>{$lang.PROFILE.STREET}</label>
        <div class="col-sm-10">
          <div class="row">
  ...
  {if "city"|in_array:$fields || "postcode"|in_array:$fields}<div class="form-group">
        <label class="col-sm-2 control-label" for="textinput"{if !("postcode"|in_array:$duty_fields) && !("city"|in_array:$duty_fields)} style="font-weight: normal;"{/if}>{$lang.PROFILE.CITY}</label>
        <div class="col-sm-10">
          <div class="row">
  ...
  {if "country"|in_array:$fields || "postcode"|in_array:$fields}<div class="form-group">
        <label class="col-sm-2 control-label" for="textinput"{if !("country"|in_array:$duty_fields)} style="font-weight: normal;"{/if}>{$lang.PROFILE.COUNTRY}</label>
        <div class="col-sm-10">
    <select name="country" class="form-control"{if "country"|in_array:$ro_fields} readonly="readonly" disabled=""{/if}>
  ...
  {if $cfg.TAXES && $cfg.EU_VAT && "vatid"|in_array:$fields}<div class="form-group">
      <label class="col-sm-2 control-label" for="textinput"{if !("vatid"|in_array:$duty_fields)} style="font-weight: normal;"{/if}>{$lang.PROFILE.VATID}</label>
      <div class="col-sm-10">
  ...
  <div class="form-group">
        <label class="col-sm-2 control-label" for="textinput"{if !("telephone"|in_array:$duty_fields)} style="font-weight: normal;"{/if}>{$lang.PROFILE.TELEPHONE}</label>
        <div class="col-sm-10">
  ...
  <div class="form-group">
    <label class="col-sm-2 control-label" for="textinput"{if !("fax"|in_array:$duty_fields)} style="font-weight: normal;"{/if}>{$lang.PROFILE.FAX}</label>
    <div class="col-sm-10">
  ...
  {if "birthday"|in_array:$fields}<div class="form-group">
        <label class="col-sm-2 control-label" for="textinput"{if !("birthday"|in_array:$duty_fields)} style="font-weight: normal;"{/if}>{$lang.PROFILE.BIRTHDAY}</label>
        <div class="col-sm-10">
  ...
  {if "website"|in_array:$fields}<div class="form-group">
        <label class="col-sm-2 control-label" for="textinput"{if !("website"|in_array:$duty_fields)} style="font-weight: normal;"{/if}>{$lang.PROFILE.WEBSITE}</label>
        <div class="col-sm-10">
  ...
  <div class="form-group">
      <label class="col-sm-2 control-label" for="textinput"{if !$c.3} style="font-weight: normal;"{/if}>{$c.0}</label>
      <div class="col-sm-10">
  ...
  <input style="opacity: 0;position: absolute;">
      ...
      <!-- Text input-->
      <div class="form-group">
        <label class="col-sm-2 control-label" for="textinput">{$lang.PROFILE.PASSWORD}</label>
        <div class="col-sm-10">
      ...
      <div class="form-group">
        <label class="col-sm-2 control-label" style="font-weight: normal;">{$lang.PROFILE.API_KEY}</label>
        <div class="col-sm-10">
      ...
      {if count($nl) > 0}
      <div class="form-group">
        <label class="col-sm-2 control-label" for="checkbox" style="font-weight: normal;">{$lang.PROFILE.NEWSLETTER}</label>
        <div class="col-sm-10">
          <div class="row">
  ...
  <div class="col-sm-offset-2 col-sm-10">
    ...
    <label>
      ...
      <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
          <button type="submit" name="p_submit" class="btn btn-primary btn-block">{$lang.PROFILE.SAVE}</button>
        </div>
      </div>
...
<div class="form-group" style="margin-bottom:0;">
  <p style="text-align:justify;margin-top:-40px;padding:0;"><div class="row">
<div class="col-md-4">
...
</div>{else} <div class="col-md-6 col-md-offset-3">
