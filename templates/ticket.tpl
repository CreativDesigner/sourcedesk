	...
	<div class="container">
        ...
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h4 class="panel-title">{$lang.TICKET.PREMIUM}</h4>
            </div>
        ...
        <div class="panel panel-primary">
            <div class="panel-heading">
                <a href="#" id="openAnswerPanel" style="color: white;"><h4 class="panel-title">{$lang.TICKET.ANSWER}</h4></a>
            </div>
            <div class="panel-body" id="answerPanel" style="display: none;">
        ...
        {foreach from=$a item=d}
        <div class="panel panel-{if $d.1}info{else}default{/if}">
            <div class="panel-heading">
                <h4 class="panel-title">{if $d.1}{$lang.TICKET.STAFF}{else}{$d.3}{/if} <span style="font-size: 8pt; font-weight: normal;">{$d.0}</span></h4>
            </div>
            <div class="panel-body">
                {$d.2|nl2br}
            </div>
