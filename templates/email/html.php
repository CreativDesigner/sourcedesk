                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateHeader">
                      <tr>
                        <td valign="top" class="headerContent">
                          <a href="<?=$pageurl; ?>">
                            <img src="<?=$browser_link; ?>&bg=0" style="max-width:600px;padding:20px" id="headerImage" alt="<?=$pagetitle; ?>" />
                          </a>
                        </td>
                      </tr>
              </table>
              ...
              <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateBody">
                <tr>
                  <td valign="top" class="bodyContent">
                    ...
                    <br /><br /><b><?=$attachments_lang; ?>:</b>
                    <?php foreach($attachments as $attachment => $link) echo "<br />- <a href='{$link}' target='_blank'>{$attachment}</a>"; ?>
                    <?php } ?>
                  </td>
                </tr>
              </table>
              ...
              <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateFooter">
                <tr>
                  <td valign="top" class="footerContent">
                    <a target="_blank" href="<?=$login_link; ?>"><?=$login_lang; ?></a>
                    <span class="hide-mobile"> - </span>
                    <a target="_blank" href="<?=$browser_link; ?>"><?=$browser_lang; ?></a>
                    <?php if(!empty($cancel_link)){ ?>
                    <span class="hide-mobile"> - </span>
                    <a target="_blank" href="<?=$cancel_link; ?>"><?=$cancel_lang; ?></a>
                    <?php } ?><br />
                    &copy; Copyright <?=$pagetitle; ?> - Alle Rechte vorbehalten.
                  </td>
                </tr>
              </table>
            </td>
...
<!--
                ...
                <?php if(!isset($cancel_link)){ ?>
                <tr>
                  <td align="center" style=" border-bottom-left-radius:4px; border-bottom-right-radius:4px;">
                    <table align="center" class="table-inner" width="160" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td height="10"></td>
                      </tr>
                      <tr>
                        <td class="text-link" align="center">
                          <table class="table-full" border="0" align="left" cellpadding="0" cellspacing="0">
                            <tr>
                              <td align="center" style="font-family: 'Open Sans', Arial, sans-serif; font-size:13px; color:#7f8c8d; line-height:30px;"><a href="<?=$browser_link; ?>"><?=$browser_lang; ?></a></td>
                            </tr>
                          </table>
                          <table class="table-full" border="0" align="right" cellpadding="0" cellspacing="0">
                            <tr>
                              <td align="center" style="font-family: 'Open Sans', Arial, sans-serif; font-size:13px; color:#7f8c8d; line-height:30px;"><a href="<?=$login_link; ?>"><?=$login_lang; ?></a></td>
                            </tr>
                          </table>
                        </td>
                      </tr>
                ...
                <tr>
                  <td align="center" style=" border-bottom-left-radius:4px; border-bottom-right-radius:4px;">
                    <table align="center" class="table-inner" width="290" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td class="text-link" align="center">
                          <table class="table-full" width="80" border="0" align="left" cellpadding="0" cellspacing="0">
                            <tr>
                              <td align="center" style="font-family: 'Open Sans', Arial, sans-serif; font-size:13px; color:#7f8c8d; line-height:30px;"><a target="_blank" href="<?=$browser_link; ?>"><?=$browser_lang; ?></a></td>
                            </tr>
                          </table>
                          ...
                          <table class="table-full" width="80" border="0" align="left" cellpadding="0" cellspacing="0">
                            <tr>
                              <td align="center" style="font-family: 'Open Sans', Arial, sans-serif; font-size:13px; color:#7f8c8d; line-height:30px;"><a target="_blank" href="<?=$cancel_link; ?>"><?=$cancel_lang; ?></a></td>
                            </tr>
                          </table>
                          <table width="1" height="15" border="0" cellpadding="0" cellspacing="0" align="left">
                            <tr>
                          ...
                          <table class="table-full" width="80" border="0" align="right" cellpadding="0" cellspacing="0">
                            <tr>
                              <td align="center" style="font-family: 'Open Sans', Arial, sans-serif; font-size:13px; color:#7f8c8d; line-height:30px;"><a target="_blank" href="<?=$login_link; ?>"><?=$login_lang; ?></a></td>
                            </tr>
                          </table>
                        </td>
                      </tr>
          ...
          <tr>
            <td align="center" style="font-family: 'Open Sans', Arial, sans-serif; font-size:13px; color:#ffffff; line-height:30px;"> © Copyright <?=date("Y"); ?> <?=$pagetitle; ?> // Foto: Richard Reiber</td>
          </tr>
          <tr>
            <td height="25"></td>
          </tr>
