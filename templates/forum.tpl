<div id="content">
	<div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    <div class="panel-heading">{$l.RECENT_ENTRIES}</div>
        ...
        <center>
            <div class="page-nation" style="margin-top: -25px;">
                <ul class="pagination pagination-large">
                    ...
                    {else}
                    <li><a href="{$cfg.PAGEURL}forum/{$f.ID}/p/{$cPage - 1}">&laquo;</a></li>
                    {/if}
                    {if ($cPage - 3) > 1}
                    <li><a href="{$cfg.PAGEURL}forum/{$f.ID}/p/1">1</a></li>
                    {if ($cPage - 3) > 2}
                    ...
                    {if $i > 0 && $i <= $pages}
                    <li><a href="{$cfg.PAGEURL}forum/{$f.ID}/p/{$i}">{$i}</a></li>
                    {/if}
                    {/for}
                    <li class="active"><a href="{$cfg.PAGEURL}forum/{$f.ID}/p/{$cPage}">{$cPage}</a></li>
                    ...
                    {/if}
                    {if ($cPage + 3) < $pages}
                    <li><a href="{$cfg.PAGEURL}forum/{$f.ID}/p/{$pages}">{$pages}</a></li>
                    {/if}
                    {if ($cPage + 1) > $pages}
                    <li class="disabled"><span>&raquo;</span></li>
                    {else}
                    <li><a href="{$cfg.PAGEURL}forum/{$f.ID}/p/{$cPage + 1}">&raquo;</a></li>
                    {/if}
                </ul>
            </div>
        </center>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">{$l.ANSWER}</div>
            <div class="panel-body">
                {if !$logged_in}
        ...
        <center>
            <div class="page-nation" style="margin-top: -25px;">
                <ul class="pagination pagination-large" style="margin-bottom: -10px;">
                    {if ($cPage - 1) <= 0}
                    <li class="disabled"><span>&laquo;</span></li>
                    {else}
                    <li><a href="{$cfg.PAGEURL}forum/{$f.ID}/{$t.ID}/p/{$cPage - 1}">&laquo;</a></li>
                    {/if}
                    {if ($cPage - 3) > 1}
                    <li><a href="{$cfg.PAGEURL}forum/{$f.ID}/{$t.ID}/p/1">1</a></li>
                    {if ($cPage - 3) > 2}
                    <li class="disabled"><span>...</span>
                    {/if}
                    {/if}
                    {for $i=($cPage - 3) to ($cPage - 1)}
                    {if $i > 0 && $i <= $pages}
                    <li><a href="{$cfg.PAGEURL}forum/{$f.ID}/{$t.ID}/p/{$i}">{$i}</a></li>
                    {/if}
                    {/for}
                    <li class="active"><a href="{$cfg.PAGEURL}forum/{$f.ID}/{$t.ID}/p/{$cPage}">{$cPage}</a></li>
                    {for $i=($cPage + 1) to ($cPage + 3)}
                    {if $i > 0 && $i <= $pages}
                    <li><a href="{$cfg.PAGEURL}forum/{$f.ID}/{$t.ID}/p/{$i}">{$i}</a></li>
                    {/if}
                    ...
                    {/if}
                    {if ($cPage + 3) < $pages}
                    <li><a href="{$cfg.PAGEURL}forum/{$f.ID}/{$t.ID}/p/{$pages}">{$pages}</a></li>
                    {/if}
                    {if ($cPage + 1) > $pages}
                    <li class="disabled"><span>&raquo;</span></li>
                    {else}
                    <li><a href="{$cfg.PAGEURL}forum/{$f.ID}/{$t.ID}/p/{$cPage + 1}">&raquo;</a></li>
                    {/if}
                </ul>
            </div>
        </center>
