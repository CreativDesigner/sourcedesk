<div class="container">
  ...
  <div>
	<ul class="nav nav-tabs" role="tablist">
	    <li class="active"><a href="#info" data-toggle="tab" role="tab">{$lang.DOMAIN.TAB1}</a></li>
	    <li><a href="#ns" data-toggle="tab" role="tab">{$lang.DOMAIN.TAB2}</a></li>
	    {if $dns && ($di->reg_info.ns|count == 2 || ($di->reg_info.ns|count == 5 && $di->reg_info.ns.0 == $cfg.NS1 && $di->reg_info.ns.1 == $cfg.NS2 && $di->reg_info.ns.2 == $cfg.NS3 && $di->reg_info.ns.3 == $cfg.NS4 && $di->reg_info.ns.4 == $cfg.NS5))}<li><a href="#dns" data-toggle="tab" role="tab">{$lang.DOMAIN.TAB3}</a></li>
	    {if $dyndns && $dns}<li><a href="#dyndns" data-toggle="tab" role="tab">{$lang.DOMAIN.TAB4}</a></li>{/if}{/if}
	    <li><a href="#owner" data-toggle="tab" role="tab">{$lang.DOMAINS.OWNERC}</a></li>
	    <li><a href="#admin" data-toggle="tab" role="tab">{$lang.DOMAINS.ADMINC}</a></li>
	    {if $user.domain_contacts}<li><a href="#tech" data-toggle="tab" role="tab">{$lang.DOMAINS.TECHC}</a></li>
	    <li><a href="#zone" data-toggle="tab" role="tab">{$lang.DOMAINS.ZONEC}</a></li>{/if}
	    {if $di->privacy_price >= 0}<li><a href="#privacy" data-toggle="tab" role="tab">{$lang.DOMAIN.TAB5}</a></li>{/if}
	    {if $freessl}<li><a href="#ssl" data-toggle="tab" role="tab">{$lang.DOMAINS.SSL}</a></li>{/if}
	    <li><a href="#delete" data-toggle="tab" role="tab">{$lang.DOMAIN.TAB6}</a></li>
	</ul>
	<br />
	<div class="tab-content">
	    ...
	    {if ($di->reg_info.ns|count == 2 || ($di->reg_info.ns|count == 5 && $di->reg_info.ns.0 == $cfg.NS1 && $di->reg_info.ns.1 == $cfg.NS2 && $di->reg_info.ns.2 == $cfg.NS3 && $di->reg_info.ns.3 == $cfg.NS4 && $di->reg_info.ns.4 == $cfg.NS5)) && $dns}<div role="tabpanel" class="tab-pane" id="dns">
	    ...
	    <div role="tabpanel" class="tab-pane" id="admin">
	    	...
	    	<form onsubmit="return false;">
	    		{if $tld != "eu"}<div class="row">
	                <div class="col-xs-12">
	                    <span class="pull-right">
				    		<a href="#" class="btn btn-default" id="owner-to-admin">{$lang.DOMAIN.COPYOWNER}</a>
				    	</span>
	                </div>
	            </div>{/if}
	    ...
	    <div role="tabpanel" class="tab-pane" id="tech">
	    	...
	    	<form onsubmit="return false;">
		    	<div class="row">
	                <div class="col-xs-12">
	                    <span class="pull-right">
				    		{if $tld != "eu"}<a href="#" class="btn btn-default" id="owner-to-tech">{$lang.DOMAIN.COPYOWNER}</a>{/if}
				    		<a href="#" class="btn btn-default" id="admin-to-tech">{$lang.DOMAIN.COPYADMIN}</a>
				    	</span>
	                </div>
	            </div>
		    	<div class="row" style="margin-top: 10px;">
	    ...
	    <div role="tabpanel" class="tab-pane" id="zone">
	    	...
	    	<form onsubmit="return false;">
		    	<div class="row">
	                <div class="col-xs-12">
	                    <span class="pull-right">
				    		{if $tld != "eu"}<a href="#" class="btn btn-default" id="owner-to-zone">{$lang.DOMAIN.COPYOWNER}</a>{/if}
				    		<a href="#" class="btn btn-default" id="admin-to-zone">{$lang.DOMAIN.COPYADMIN}</a>
				    		<a href="#" class="btn btn-default" id="tech-to-zone">{$lang.DOMAIN.COPYTECH}</a>
				    	</span>
	                </div>
	            </div>
		    	<div class="row" style="margin-top: 10px;">
	    ...
	    {if $freessl}<div role="tabpanel" class="tab-pane" id="ssl" style="text-align: justify;">
			{if !empty($hasSslReset)}
			<div class="alert alert-success">{$lang.DOMAINS.SSL_RESET}</div>
			{/if}
			...
			{if $ssl_days_left <= 14}
			<br /><div class="alert alert-warning">{$lang.DOMAINS.SSL_DAYS_LEFT|replace:"%u":('<a href="?ssl_reset=1#ssl">'|cat:$lang.DOMAINS.SSL_DAYS_RENEW|cat:'</a>')}</div>
			{/if}
	    	{/if}
	    	{/if}
	    </div>{/if}
